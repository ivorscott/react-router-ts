...
function generateTitle(teamId: string, index: any) {
  return teamId[0].toUpperCase() + teamId.slice(1) + ' ' + articleInfo[index].title;
}

export function generateArticle(teamId: string, articleId: any) {
...
export function generateTeamsArticles(teamId: string) {
